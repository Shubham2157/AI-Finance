...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: Replace with your Spring Boot registration endpoint
      ...
      // Mock registration - remove this when connecting to backend
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-4 sm:p-6">
      ...
      <Card className="w-full max-w-md shadow-xl bg-white dark:bg-slate-800 border-emerald-100 dark:border-slate-700">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-xl sm:text-2xl font-bold dark:text-white">Create Account</CardTitle>
          <CardDescription className="text-sm sm:text-base dark:text-slate-300">Start managing your finances today</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm sm:text-base dark:text-slate-200">Full Name</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-sm sm:text-base dark:text-slate-200">Confirm Password</Label>
              <Input
                id="confirmPassword"
                type="password"
